...
from skimage.segmentation import felzenszwalb, slic, quickshift, mark_boundaries, relabel_sequential
...
def get_input_image(fname):
    ...
    input_image = ndimage.median_filter(input_image, 7)
...
def show_orig(fig):
    ...
    image = get_input_image('input_samples/32910912.jpg')
